...
export default function BasicMenu() {
    ...
    // Assuming you have the home object available
    const home = { idHome: 1 }; // Replace with the actual home object
    ...
    return (
        <div>
            ...
            >
                ...
                <MenuItem>
                    <UploadImage homeId={home.idHome} /> {/* Pass the homeId dynamically */}
                </MenuItem>
                <MenuItem onClick={handleClose} className="menu-items">
                    Log out
                </MenuItem>
