...
import { resetFilter } from "../../redux/slice/homeSlice";
...
function Header() {
    ...
    return (
        <>
            <div className="navbar">
                ...
                <div className="search-bar">
                    ...
                    <div className="search-icon-div">
                        <SearchRoundedIcon className="search-icon" onClick={handleOpenDialog} />
                        <MobileSearchBar />
                    </div>
                </div>
            ...
            <BasicModal openModal={openModal} setOpenModal={setOpenModal} handleCreateHome={handleCreateHome} />
        </>
    );
}
